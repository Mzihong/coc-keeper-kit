---
name: create-monster
description: Stat a Call of Cthulhu 7th Edition monster or Mythos entity — characteristics, attacks, Sanity loss to witness, special abilities, and the fair way to survive it. Use whenever the user wants a creature, undead, cultist horror, servitor race, or Great Old One. Writes to reference/bestiary/ (reusable) or the campaign when plot-bound.
version: "1.0.0"
---
