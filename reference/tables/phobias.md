# phobias.md — 恐惧症状表(Phobias)

> 来源:《守秘人规则书》表IX 恐惧症状表(5288–5427)

《守秘人规则书》表IX 的完整 D100 逐条转录,供直接掷骰查表。**与
`reference/decks/phobias-and-manias-zh.md` 不是同一份材料、不互相重复**:那份文件是
官方卡组的中译收录,只覆盖 16 条恐惧症(带更长的症状描写与游戏效果段落,可直接读给
玩家),是精选的"卡面版";本文件是规则书表格本身的全量转录,给守秘人在需要真正随机
(或从全量列表里手选)一个恐惧源时查表用,条目简短(一行病理定义),不含卡组那样的
机制段落。两者用途不同,互为补充。

守秘人可投 D100 随机选择,也可直接选一个恰当的症状;选定后记入调查员背景故事栏。
新获得的恐惧症属于疯狂发作的一部分,见 `madness-instant.md`(表VII 9 号)/
`madness-summary.md`(表VIII 9 号);会随场次**习惯化**,见 `reference/rules/sanity.md`
→ 8.5 习惯恐惧。
...
| 94 | 十三恐惧症 (Triskadekaphobia) | 对数字13的恐惧。 |
...
> **规则书原注**:催眠恐惧症(Hypnophobia)、恐牙症(牙医恐惧症/Odontophobia)、魔法恐惧症
> (权杖恐惧症/Rhabdophobia)和怪物恐惧症(畸形恐惧症/Teratophobia)四条,规则书原文标注
> 疑为对英文原文理解有误,目前按中译原文照录,未做改写。
