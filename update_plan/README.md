...
**当前没有排队条目。** P5 阶段 1 与阶段 3 的取舍已于 2026-08-07 一并定案(阶段 1 落地,
阶段 3 砍掉),P10 也已完成——两条曾在这里排队的条目都做完了。剩下能动的都是**可选**
后续阶段(P5 阶段 2/2b 家具层与室外站点图、P14 阶段 2 种子表 bug 修复),不阻塞任何计划
完结,由 Keeper 按需再排进本节。
...
**阶段 3(ChatGPT 降级路径)同日拍板砍掉**——`core/00` 已写死 kit 只支持有文件系统的
agent,那个使用场景不存在了。详见计划文件「阶段 1」「阶段 3」两节与 `WORKLOG.md`。
