...
| # | 计划 | 范围 | 状态 | 阻塞/等待 |
|---|---|---|---|---|
| P1 | [cult-doc-integration](2026-08-02-cult-doc-integration.md) | 克苏鲁教团 docx 四章提炼进 kit + 敌对势力 intake 问题 + 附加寄放:NPC 互动史惯例(2026-08-02) | 进行中(阶段 0/1/2 与附加项全部落盘,内容待提交;只剩阶段 3 收尾) | 无——只剩 README 登记、review-material 审计、归档进 `Archived/` 这类收尾工作,无外部依赖;E(关系图惯例)留给 P5 |
...
graph LR
    ...
    P1a["✅ P1 阶段0-2+附加项<br/>全部落盘,只剩阶段3收尾"]
    P2["✅ P2 多章/分支结构"]
...
**P1 阶段 0/1/2 与附加项全部落盘**——第四章(邪教徒/怪物/造物)只用了自身需要的
7 个新法术,没有等 P7 的完整速查;阶段 2(敌对势力 intake 问题、campaign `Threat`
字段)也已接线完毕。P1 只剩阶段 3 收尾(README 登记、review-material 审计、归档)。
...
1. **P1 阶段 3(收尾)** — README 登记、review-material 审计、归档进 `Archived/`,
   纯收尾工作量,无外部依赖
...
| 6 | **P1** 教团文档整合 | ★☆☆☆☆(降级) | 阶段 0/1/2 与附加项全部落盘;只剩阶段 3 收尾(README 登记 + review-material 审计 + 归档) | 曾是本表最重的计划(四章提炼),现已做完;剩下的是任何计划完结都要走的标准收尾流程,不是本计划特有的工作量 | ✅ 是 |
