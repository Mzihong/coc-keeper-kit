...
| # | 计划 | 范围 | 状态 | 阻塞/等待 |
|---|---|---|---|---|
| P1 | [cult-doc-integration](2026-08-02-cult-doc-integration.md) | 克苏鲁教团 docx 四章提炼进 kit + 敌对势力 intake 问题 + 附加寄放:NPC 互动史惯例(2026-08-02) | 进行中(阶段 0 完成;阶段 1 第一/二/三章均已落盘,内容待提交;剩第四章与阶段 2) | 第四章两个硬前置均已解除(P7 转换稿已归档、P4 人类侧已完成)——可以开工;第三章 D 第二项(campaign `Threat` 字段)与 E(关系图惯例)留给阶段 2 / P5;附加项(NPC 互动史)无依赖可随时做 |
...
第四章的两个硬前置(P7 魔法速查、P4 反派强度预算)**均已解除**:P7 的转换稿已归档
(2026-08-02),P4 人类侧内容已落盘(2026-08-02 第五轮)。第四章现在唯二没做的原因
只是"还没有人去做",不再是"等谁拍板"。
P8 不是硬前置,但已定案待执行——建议在第四章落盘前做完,否则精英卡缺法术栏要返工。
P9 也不是硬前置——`core/07` 的占位句已落盘,人类侧的 P4 完全不等它。
活动计划中仍在等 Keeper 的只剩 P5(风格/范围)、P9(范围);
P1 第四章、P6 剩余条目、P7、P8 现在都可以直接开工,没有外部拍板阻塞。

## 建议执行顺序

~~P2 多章/分支~~ ~~P3 惯例缺口(结算+成长+追逐+缩放)~~ ~~P4 反派强度预算(人类侧)~~
~~P1 阶段 1 第一/二/三章~~ —— 已完成/已落盘。剩下的:

1. **P7 魔法速查** — 阻塞已解除(转换稿已归档),可以直接执行
2. **P1 第四章 → P1 阶段 2(敌对势力问题)** — 两个硬前置(P7、P4)均已解除,依赖链最深,
   但已经没有外部拍板阻塞,只是工作量大
3. **P8 卡渲染缺口** — 已定案(全渲染+自校验),建议赶在第四章的精英卡之前做完,
   否则精英卡要返工重渲
...
| 6 | **P1** 教团文档整合 | ★★★★★ | 第一/二/三章已落盘;剩第四章 + 阶段 2,跨 `core/`+`reference/`+ intake | 体量是第二名的数倍。**第四章的两个硬前置(P4、P7)现在都已解除**,不再是"等谁拍板",纯粹是工作量大,只能分章推进 | 🟢 第一/二/三章已落盘;第四章可开工,无外部阻塞 |
