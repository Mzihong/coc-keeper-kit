...
| # | 计划 | 范围 | 状态 | 阻塞/等待 |
|---|---|---|---|---|
| P5 | [low-cost-maps](2026-08-02-low-cost-maps.md) | 低成本地图:mermaid 惯例(还债)+ DSL→SVG 渲染器,两个功能——KP 定位图(A 档)与 PL 可互动场景图(A+B 家具层);阶段 4 引线标注改编号圆圈 + 图旁注释栏。**所有阶段均已完成** | 进行中(阶段 0-2b 于 2026-08-08 提交 `d56c0dc`;**阶段 4 于 2026-08-08 完成并提交 `<commit>`**) | **无阻塞,也没有可动阶段了**。只剩一项非阻塞收尾:"实测功能一/二的 token 差回填 3–5× 估算"——需要一次真实的功能二(玩家版互动场景图)生成才能测,`beyond-the-treeline` 至今只出过守秘人版,留到 Keeper 真正生成时回填。**回填完即可整份归档** |
